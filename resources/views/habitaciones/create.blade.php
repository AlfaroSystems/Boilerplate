...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-white dark:bg-[#161615] p-6 rounded-xl shadow">
        ...
        <form action="{{ route('habitaciones.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            @csrf
            ...
            <div>
                ...
                <input type="text" name="numero_habitacion" value="{{ old('numero_habitacion') }}" required
            ...
            <div>
                ...
                <textarea name="descripcion" rows="3"
                    class="w-full p-2 border rounded bg-white dark:bg-[#1C1C1B] dark:border-[#3E3E3A] dark:text-white focus:ring-2 focus:ring-indigo-500 outline-none transition">{{ old('descripcion') }}</textarea>
            </div>
